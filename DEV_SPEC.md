...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2026-04-03 | ✅ 完成 |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2026-04-03 | ✅ 完成 |
| A3 | 配置加载与校验（Settings） | [x] | 2026-04-03 | ✅ 完成 — Settings dataclass + load_settings + validate_settings |
